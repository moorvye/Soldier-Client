...
class MainActivity : HelperBaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    val intent = Intent(
        Intent.ACTION_VIEW,
        Uri.parse("https://t.me/SoldierClient")
    )
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_soldier_scanner -> requestActivityLauncher.launch(Intent(this, com.v2ray.ang.ui.SoldierScannerActivity::class.java))
            ...
            R.id.domain_resolver -> {
            startActivity(Intent(this, DomainResolverActivity::class.java))
        }
    }
